          ...
          <div className="divide-y divide-gray-50 dark:divide-slate-800">
            {logs.map((log) => {
              ...
              return (
                <div
                  key={log._id}
                  className="p-6 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors flex items-start gap-6"
                >
                  <div
                    className={`p-3 rounded-xl bg-gray-50 dark:bg-slate-800 text-gray-400 dark:text-slate-500`}
                  >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center gap-3">
                      <span
                        className={`px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider ${ACTION_COLORS[log.action]}`}
                      >
                        {log.action}
                      </span>
